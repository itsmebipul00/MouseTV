...
export function makeServer({ environment = 'development' } = {}) {
	return new Server({
		...
		routes() {
			...
			this.post('/auth/authenticateUser', authenticateUser.bind(this))
			...
			this.get(
				'/user/watchlater',
				getWatchLaterVideosHandler.bind(this)
			)
			this.post(
				'/user/watchlater',
				addItemToWatchLaterVideos.bind(this)
			)
			this.delete(
